          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="max-w-[470px]">
              ...
              <div className="mb-1">
                ...
                <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                We understand the importance of practical experience in today's competitive job market. Our institution boasts strong collaborations with leading industries and organizations, providing students with hands-on experience through internships, workshops, and real-world projects. Our dedicated career services ensure that students are prepared for success from day one.
                </p>
              </div>
            </div>
          </div>
